# -*- coding: utf-8 -*-
"""Figuras_HEC14Dias.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1uXeeq5YMZY_gXiS74y7LoY-qeQkZ0u8K
"""
...
def getLastProno(cal_id=454,filter={}):
    ...
    if not (len(json_response['series'])):
        print("No prono series found")
        return None,parser.parse(json_response["forecast_date"])
...
def plotFinal(df_obs,df_sim,nameout='productos/plot_final.png',titulo='puerto',ydisplay=1,xytext=(-300,-200),ylim=(-1,2.5),markersize=None,text_xoffset=(-8,-8),obs_label='Nivel Observado',extraObs=None,extraObsLabel='Nivel Observado 2', fecha_emision = None, bandaDeError=('e_pred_01','e_pred_99'),obsLine=False,nombre_estacion="Estación",niveles_alerta={}, cero=0):
    ...
    f_finTabla = (ahora + timedelta(days=5)).replace(hour=0, minute=0, second=0)
    df_prono = df_prono[df_prono.index < f_finTabla ]
...
def corrigeZarate(plots=False, upload=True, output_csv=False):
    ...
    df_Zarate_sim, fecha_emision = getLastProno(454,{'estacion_id': '5907', 'var_id': 2})
    print(fecha_emision)
    if(df_Zarate_sim is None):
        print("prono series not found")
        return
    ## Carga Observados
    ...
    # PLOT FINAL
    plotFinal(df_Zarate_Obs,df_Zarate_sim2,'productos/Prono_Zarate_15D.png',ydisplay=-0.75,text_xoffset=(-2,-8),xytext=(-320,-200),ylim=(-1,2.5),nombre_estacion="Zárate",niveles_alerta={"aguas_bajas":0.3},cero=0.42,fecha_emision=fecha_emision) # ,"alerta":2,"evacuacion":2.2

    ## UPLOAD PRONOSTICO
    if upload:
        uploadPronoSeries(series,cal_id=461,forecast_date=fecha_emision,outputfile="productos/prono_zarate_15D.json",responseOutputFile="productos/pronoresponse.json")
    else:
        data = prono2json(series,forecast_date=fecha_emision)
        outputjson(data,"productos/prono_zarate_15D.json")
    
    if output_csv:
        outputcsv(df_Zarate_sim2,"productos/Prono_Zarate_15D.csv")
...
def corrigeAtucha(plots=False, upload=True, output_csv=False):
    ...
    df_Atucha_sim, fecha_emision = getLastProno(454,{'estacion_id': '151', 'var_id': 2})
    print(fecha_emision)
    if(df_Atucha_sim is None):
        print("prono series not found")
        return
    ## Carga Observados
    ...
    # PLOT FINAL
    plotFinal(df_Atucha_Obs,df_Atucha_sim2,'productos_res/Prono_Atucha_15D.png',ydisplay=0,xytext=(-420,-120),ylim=(-0.5,3.5),nombre_estacion="Atucha",fecha_emision=fecha_emision,cero=-0.53)
    plotFinal(df_Atucha_Obs,df_Atucha_sim2,nameout='productos/Prono_Lima_15D.png',ydisplay=0,text_xoffset=(-2,-5),xytext=(-320,-200),ylim=(-0.5,3.5),fecha_emision=fecha_emision,nombre_estacion="Lima",cero=-0.53)

    if output_csv:
        outputcsv(df_Atucha_sim2,"productos_res/Prono_Atucha_15D.csv")
    ...
    df_Campana_sim, fecha_emision = getLastProno(454,{'estacion_id': '41', 'var_id': 2})
    if(df_Campana_sim is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(df_Campana_Obs,df_Campana_sim,nameout='productos/Prono_Campana_15D.png',markersize=10,ydisplay=-0.75,text_xoffset=(-2,-5),xytext=(-320,-200),ylim=(-1.,2),obsLine=False,nombre_estacion="Campana", cero=0.03, fecha_emision=fecha_emision)

    if output_csv:
        outputcsv(df_Campana_sim,"productos/Prono_Campana_15D.csv")
    ...
    Carga los datos desde la api de Alerta
    """
    df_Escobar_sim, fecha_emision = getLastProno(454,{'estacion_id': '42', 'var_id': 2})
    if(df_Escobar_sim is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(df_Escobar_Obs,df_Escobar_sim,nameout='productos/Prono_Escobar_15D.png',markersize=10,ydisplay=-0.75,text_xoffset=(-2,-5),xytext=(-320,-200),ylim=(-1.,3),obsLine=False,nombre_estacion="Escobar",fecha_emision=fecha_emision)
    
    ## UPLOAD PRONOSTICO
    if upload:
        uploadPronoSeries(series,cal_id=455,forecast_date=fecha_emision,outputfile="productos/prono_atucha_15D.json",responseOutputFile="productos/pronoresponse.json")
    else:
        data = prono2json(series,forecast_date=fecha_emision)
        outputjson(data,"productos/prono_atucha_15D.json")

    if output_csv:
        outputcsv(df_Escobar_sim,"productos/Prono_Escobar_15D.csv")

"""### Rosario"""

def corrigeRosario(plots=False,upload=True, output_csv=False):
    ## Carga Simulados en Rosario
    df_Rosario_sim, fecha_emision = getLastProno(454,{'estacion_id': '5893','var_id':2})
    if(df_Rosario_sim is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(df_Rosario_Obs,df_Rosario_sim2,nameout='productos/Prono_Rosario_15D.png',ydisplay=-0.75,text_xoffset=(0.5,0),ylim=(-1,2), obsLine=False,nombre_estacion="Rosario", cero=2.92,fecha_emision=fecha_emision)
    ...
    # PLOT FINAL
    plotFinal(df_RosarioPNA_Obs,df_Rosario_sim2,nameout='productos/Prono_RosarioPNA_15D.png',ydisplay=1.5,text_xoffset=(0,0),xytext=(-320,-200),ylim=(-1,2),obs_label='Nivel Observado PNA',extraObs=df_Rosario_Obs,extraObsLabel="Nivel Observado BDHI",fecha_emision=fecha_emision,obsLine=False,nombre_estacion="Rosario")

    if output_csv:
        outputcsv(df_Rosario_sim2,"productos/Prono_Rosario_15D.csv")

    """# Prediccion en Timbues"""
    df_Timbues_sim, fecha_emision = getLastProno(454,{'estacion_id': '1770','var_id':2})
    if(df_Timbues_sim is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(None,df_Timbues_sim,nameout='productos/Prono_Timbues_15D.png',ydisplay=3.4,text_xoffset=(0,0),ylim=(2,7),nombre_estacion="Timbúes",fecha_emision=fecha_emision)
    
    ## UPLOAD PRONOSTICO
    if upload:
        uploadPronoSeries(series,cal_id=459,forecast_date=fecha_emision,outputfile="productos/prono_rosario.json_15D",responseOutputFile="productos/pronoresponse.json")
    else:
        data = prono2json(series,forecast_date=fecha_emision)
        outputjson(data,"productos/prono_rosario_15D.json")
    
    if output_csv:
        outputcsv(df_Timbues_sim,"productos/Prono_Timbues_15D.csv")

"""### Villa Constitucion"""

def corrigeVCons(plots=False,upload=True, output_csv=False):
        ## Carga Simulados en VConstitucion
    df_VConstitucion_sim, fecha_emision = getLastProno(454,{'estacion_id': '5905','var_id':2})
    if(df_VConstitucion_sim is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(df_VConstitucion_Obs,df_VConstitucion_sim2,nameout='productos/Prono_VConstitucion_15D.png',ydisplay=-0.75,text_xoffset=(0.5,0),xytext=(-300,-100),ylim=(-1,2),bandaDeError=('e_pred_05','e_pred_95'),nombre_estacion="Villa Constitución",niveles_alerta={"aguas_bajas":1.9}, cero=1.98, fecha_emision=fecha_emision)
    ...
    # PLOT FINAL
    plotFinal(df_VConstitucionPNA_Obs,df_VConstitucion_sim2,nameout='productos/Prono_VConstitucionPNA_15D.png',ydisplay=1.5,text_xoffset=(-.5,.5),xytext=(-320,-200),ylim=(-1.,2),bandaDeError=('e_pred_05','e_pred_95'),extraObs=df_VConstitucion_Obs,extraObsLabel='Nivel Observado BDHI',obs_label='Nivel Observado PNA',fecha_emision=fecha_emision,obsLine=False,nombre_estacion="Villa Constitución",niveles_alerta={"aguas_bajas":1.9}, cero=1.98)

    if output_csv:
        outputcsv(df_VConstitucion_sim2,"productos/Prono_VConstitucion_15D.csv")


    """# Prediccion en SanNicolas"""

    df_SanNicolas_sim, fecha_emision = getLastProno(454,{'estacion_id': '36','var_id':2})
    if(df_SanNicolas_sim is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(df_SanNicolas_Obs,df_SanNicolas_sim,nameout='productos/Prono_SanNicolas_15D.png',ydisplay=-0.75,text_xoffset=(0.5,0.5),ylim=(-1.,2),bandaDeError=('e_pred_05','e_pred_95'),markersize=10,obsLine=False,nombre_estacion="San Nicolás",niveles_alerta={"aguas_bajas":1.8}, cero=1.91,fecha_emision=fecha_emision)

    if output_csv:
        outputcsv(df_SanNicolas_sim,"productos/Prono_SanNicolas_15D.csv")


    """# Prediccion en Ramallo"""
    df_Ramallo_sim, fecha_emision = getLastProno(454,{'estacion_id': '37','var_id':2})
    if(df_Ramallo_sim is None):
        print("prono series not found")
        return
    ###### Correccion 1 el simulado en zarate de retrasa dos horas
    ...
    # PLOT FINAL
    plotFinal(df_Ramallo_Obs,df_Ramallo_sim,nameout='productos/Prono_Ramallo_15D.png',ydisplay=-0.75,text_xoffset=(0.5,0.5),ylim=(-1.,2),bandaDeError=('e_pred_05','e_pred_95'),markersize=10,obsLine=False,nombre_estacion="Ramallo",niveles_alerta={"aguas_bajas":1.8}, cero=1.91,fecha_emision=fecha_emision)

    if output_csv:
        outputcsv(df_Ramallo_sim,"productos/Prono_Ramallo_15D.csv")

        
    ## UPLOAD PRONOSTICO
    if upload:
        uploadPronoSeries(series,cal_id=460,forecast_date=fecha_emision,outputfile="productos/prono_vconstitucion_15D.json",responseOutputFile="productos/pronoresponse.json")
    else:
        data = prono2json(series,forecast_date=fecha_emision)
        outputjson(data,"productos/prono_vconstitucion_15D.json")

"""### Carabelas"""

def corrigeCarabelas(plots=False,upload=True,output_csv=False):
    ## Carga Simulados
    df_simulado, fecha_emision = getLastProno(454,{'estacion_id': '5876','var_id':2})
    if(df_simulado is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(df_Obs,df_simulado,ydisplay=3.4,text_xoffset=(0.5,0.5),ylim=(-0.5,3.5),nameout='productos/prono_carabelas_15D.png',nombre_estacion="Carabelas",cero=None,fecha_emision=fecha_emision)

    if output_csv:
        outputcsv(df_simulado,"productos/prono_carabelas_15D.csv")
    ...
    ## UPLOAD PRONOSTICO
    if upload:
        uploadPronoSeries(series,cal_id=457,forecast_date=fecha_emision,outputfile="productos/prono_carabelas_15D.json",responseOutputFile="productos/pronoresponse.json")
    else:
        data = prono2json(series,forecast_date=fecha_emision)
        outputjson(data,"productos/prono_carabelas_15D.json")
...
def corrigeNuevaPalmira(plots=False,upload=True,output_csv=False):
  ...
  ## UPLOAD PRONOSTICO
  if upload:
      uploadPronoSeries(series,cal_id=458,forecast_date=fecha_emision,outputfile="productos/prono_NuevaPalmira.json",responseOutputFile="productos/pronoresponse.json")
  else:
      data = prono2json(series,forecast_date=fecha_emision)
...
def corrigeBrazoLargo(plots=False,upload=True,output_csv=False):
    ## Carga Simulados
    df_simulado, fecha_emision = getLastProno(454,{'estacion_id': '2830','var_id':2})
    if(df_simulado is None):
        print("prono series not found")
        return
    ...
    # PLOT FINAL
    plotFinal(df_Obs,df_simulado,ydisplay=3.4,text_xoffset=(0.5,0.5),ylim=(-1.5,2.5),nameout='productos/prono_BrazoLargo_15D.png',nombre_estacion="BrazoLargo",cero=None,fecha_emision=fecha_emision)

    if output_csv:
        outputcsv(df_simulado,"productos/BrazoLargo_15D.csv")
    ...
    ## UPLOAD PRONOSTICO
    if upload:
        uploadPronoSeries(series,cal_id=456,forecast_date=fecha_emision,outputfile="productos/prono_BrazoLargo_15D.json",responseOutputFile="productos/pronoresponse.json")
    else:
        data = prono2json(series,forecast_date=fecha_emision)
        outputjson(data,"productos/BrazoLargo_15D.json")

def runPlan(plan,plots=False,upload=True,output_csv=False):
    planes = {
...
# corrigeNuevaPalmira(plots=True,upload=False)
